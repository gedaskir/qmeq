            ...
            for l in range(nleads):
                ...
                for b1, a1 in itertools.product(si.statesdm[bcharge], si.statesdm[acharge]):
                    ...
                    for l1 in range(nleads):
                        kern1[l, cb, b1a1] = kern1[l, cb, b1a1] - Tba[l1, c, b1]*Tba[l1, a1, b]*(+func_2vN(+(Ek-E[b1]+E[b]), Ek_grid, l1, +1, hfkp)
                ...
                for b1 in si.statesdm[bcharge]:
                    ...
                    for l1 in range(nleads):
                        for c1 in si.statesdm[ccharge]:
                            kern1[l, cb, cb1] = kern1[l, cb, cb1] - Tba[l1, b1, c1]*Tba[l1, c1, b]*func_2vN(+(Ek-E[c]+E[c1]), Ek_grid, l1, +1, hfkp)
                        for a1 in si.statesdm[acharge]:
                            kern1[l, cb, cb1] = kern1[l, cb, cb1] + Tba[l1, b1, a1]*Tba[l1, a1, b]*func_2vN(-(Ek-E[c]+E[a1]), Ek_grid, l1, -1, hfkm)
                # 1st and 3rd terms
                for c1 in si.statesdm[ccharge]:
                    c1b = lenlst[bcharge]*dictdm[c1] + dictdm[b] + shiftlst1[bcharge]
                    for l1 in range(nleads):
                        for b1 in si.statesdm[bcharge]:
                            kern1[l, cb, c1b] = kern1[l, cb, c1b] - Tba[l1, c, b1]*Tba[l1, b1, c1]*func_2vN(+(Ek-E[b1]+E[b]), Ek_grid, l1, +1, hfkm)
                        for d1 in si.statesdm[dcharge]:
                            kern1[l, cb, c1b] = kern1[l, cb, c1b] + Tba[l1, c, d1]*Tba[l1, d1, c1]*func_2vN(-(Ek-E[d1]+E[b]), Ek_grid, l1, -1, hfkp)
                #
                for d1, c1 in itertools.product(si.statesdm[dcharge], si.statesdm[ccharge]):
                    ...
                    for l1 in range(nleads):
                        kern1[l, cb, d1c1] = kern1[l, cb, d1c1] - Tba[l1, c, d1]*Tba[l1, c1, b]*(+func_2vN(+(Ek-E[c]+E[c1]), Ek_grid, l1, +1, hfkm)
